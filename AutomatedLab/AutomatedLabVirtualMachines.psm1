...
function Copy-LabALCommon
{
    ...
    $machines = Get-LabVm -ComputerName $ComputerName | Where-Object -FilterScript {-not $_.InternalNotes.ALCommonCopied}

    if (-not $machines) { return }
    
    $module = Get-Module -Name AutomatedLab.Common -ListAvailable | Sort-Object -Property Version | Select-Object -Last 1
    Send-ModuleToPSSession -Module $module -Session (New-LabPSSession -ComputerName $machines) -Scope AllUsers -IncludeDependencies
